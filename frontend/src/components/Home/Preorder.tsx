...
export default function Preorder({
    ...
    >
      <div className="img object-scale-down w-full h-[180px] rounded-t-[10px] overflow-hidden relative">
        <img
          ...
          onError={() =>
            console.error(
              "Image load failed:",
              `http://localhost:8080/images/header/${game.kep_id}.jpg`
            )
          }
        />
        <motion.button
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="flex justify-center space-x-2 text-neutral-300 text-xs mb-2">
          <span className="bg-[#2a2a2a] px-2 py-0.5 rounded-full">
            {genre?.mufaj_nev ?? "Ismeretlen műfaj"}
          </span>
        </div>
  ...
  return (
    <div className="flex flex-col items-center mt-10">
      <h1 className="text-4xl font-bold mb-2">Játékok, amiket már most imádnak</h1>
      <h2 className="font-bold mt-2 text-lg text-center text-neutral-500 max-w-4xl">
        Rendeld elő most, hogy ne maradj le a megjelenés napjáról!
      </h2>
